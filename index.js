...
const player = new Player({position:{ x: canvas.width/2, y: canvas.height/2}, velocity: {x: 0, y: 0},
})
...
// creating const for spaceship speed, rotation speed, and how fast it stops(fricton)
const SPEED = 3
const ROTATIONAL_SPEED = 0.05
const FRICTION = 0.97
const PROJECTILE_SPEED = 3

// const for projectiles
